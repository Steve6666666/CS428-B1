...
public class RoleBase : MonoBehaviour
{
    ...
    public void MoveToTarget(Vector3 targetPos)
    {
        ...
        if (checkA == true)
        {
            ...
            gameObject.GetComponent<pathfinding>().TargetPosition.position = targetPos;
            Vector3 temp = new Vector3(0, (float)0.5, 0);
            gameObject.GetComponent<pathfinding>().TargetPosition.position += temp;
        }
        nav.SetDestination(targetPos);
    }
